...
Bien que `OAuth2OOo` et/ou `gDriveOOo` **ne partage ni ne transfert aucune données avec toutes autre application**, `OAuth2OOo` et/ou `gDriveOOo` respecte [la politique de données utilisateur des services API Google][7], y compris les exigences d'utilisation limitée.
