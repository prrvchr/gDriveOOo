...
class DriveFolderContent(unohelper.Base, XServiceInfo, PyComponent, PyInitialization,
                         PyPropertyContainer, XContent, XCommandProcessor2, XChild, XContentCreator, XCallback,
    ...
    def notify(self, data):
        if data.Action == uno.getConstantByName('com.sun.star.ucb.ContentAction.INSERTED'):
            ...
            values = gdrive.getContentValues(data.Content, properties)
...
#        commands['createNewContent'] = gdrive.getCommand('createNewContent', 'com.sun.star.ucb.ContentInfo')
        ...
        commands['delete'] = gdrive.getCommand('delete', 'boolean')
