...
g_ImplementationName = 'com.gmail.prrvchr.extensions.gDriveOOo.GoogleDriveDocumentContent'


class PyGoogleDriveDocumentContent(unohelper.Base, XServiceInfo, PyComponent, PyInitialization,
    ...
    def __init__(self, ctx, *namedvalues):
        ...
        print("PyGoogleDriveDocumentContent.__init__()")
    ...
    def execute(self, command, id, environment):
        print("PyGoogleDriveDocumentContent.execute(): %s" % command.Name)
...
g_ImplementationHelper.addImplementation(PyGoogleDriveDocumentContent,              # UNO object class
